...
@Component({
    selector: 'createOrEditLeasedAssetModal',
    templateUrl: './create-or-edit-leased-asset-modal.component.html'
})
export class CreateOrEditLeasedAssetModalComponent extends AppComponentBase {
