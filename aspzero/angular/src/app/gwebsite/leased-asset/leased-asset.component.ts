import { ViewLeasedAssetModalComponent } from './view-leased-asset-modal.component';
...
import { CreateOrEditLeasedAssetModalComponent } from './create-or-edit-leased-asset-modal.component';

@Component({
    templateUrl: './leased-asset.component.html',
...
export class CustomerComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    @ViewChild('createOrEditModal') createOrEditModal: CreateOrEditLeasedAssetModalComponent;
    @ViewChild('viewLeasedAssetModal') viewCustomerModal: ViewLeasedAssetModalComponent;
